...
- Version mismatch between PR title and package.json/CHANGELOG files
...
- Options presented with only human-team effort estimates — should show both human and CC+ship time
