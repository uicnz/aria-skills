...
Shared reference for the canonical TODOS.md format. Referenced by `/ship` (Step 5.5) and `/plan-review-founder` (TODOS.md updates section) to ensure consistent TODO item structure.
