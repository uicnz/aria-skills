...
# /plan-review-design: Designer's Eye Plan Review
...
Re-run loop: invoke /plan-review-design again → re-rate → sections at 8+ get a quick pass, sections below 8 get full treatment.
...
echo '{"skill":"plan-review-design","timestamp":"TIMESTAMP","status":"STATUS","overall_score":N,"unresolved":N,"decisions_made":N}' >> ~/.ship/projects/$SLUG/$BRANCH-reviews.jsonl
```
