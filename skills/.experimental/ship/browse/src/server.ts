/**
 * ship browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.ship/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.ship/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
	...
	const lines = [
		"ship browse — headless browser for AI agents",
		"",
		"Commands:",
	];
