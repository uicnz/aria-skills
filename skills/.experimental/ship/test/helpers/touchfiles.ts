...
export const E2E_TOUCHFILES: Record<string, string[]> = {
	...
	// Plan reviews
	"plan-review-founder": ["plan-review-founder/**"],
	"plan-review-founder-selective": ["plan-review-founder/**"],
	"plan-review-eng": ["plan-review-eng/**"],
	...
	"plan-review-design-plan-mode": ["plan-review-design/**"],
	"plan-review-design-no-ui-scope": ["plan-review-design/**"],
	"design-review-fix": ["design-review/**", "browse/src/**"],

	// ship-upgrade
	"ship-upgrade-happy-path": ["ship-upgrade/**"],
};
