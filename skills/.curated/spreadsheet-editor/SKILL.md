...
description: 'Use when a task involves creating, editing, analyzing, formatting, recalculating, or visually reviewing an `.xlsx`, `.csv`, or `.tsv` spreadsheet.'
---
...
Use formula-aware workflows that preserve references and formatting, cache recalculated values when possible, and render relevant sheets for visual review before delivery.
...
- Write final artifacts under `output/spreadsheet-editor/` when working in this repo.
