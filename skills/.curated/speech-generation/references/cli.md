...
export TTS_GEN="$ARIA_HOME/skills/speech-generation/scripts/text_to_speech.py"
```
...
```
mkdir -p tmp/speech-generation
cat > tmp/speech-generation/jobs.jsonl << 'JSONL'
{"input":"Thank you for calling. Please hold.","voice":"cedar","response_format":"mp3","out":"hold.mp3"}
{"input":"For sales, press 1. For support, press 2.","voice":"marin","instructions":"Tone: clear and neutral. Pacing: slow.","response_format":"wav"}
JSONL

python "$TTS_GEN" speak-batch --input tmp/speech-generation/jobs.jsonl --out-dir out --rpm 50

# Cleanup (recommended)
rm -f tmp/speech-generation/jobs.jsonl
```
