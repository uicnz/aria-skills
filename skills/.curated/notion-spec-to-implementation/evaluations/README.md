...
Evaluation scenarios for testing the Spec to Implementation skill across different Aria models.
...
- Creates tasks that Aria can implement with clear acceptance criteria
