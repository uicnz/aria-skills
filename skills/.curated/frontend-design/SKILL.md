...
description: Use when a task calls for a visually distinctive landing page, website, app, prototype, demo, or game interface.
---
...
Prioritize art direction, hierarchy, restraint, imagery, and motion over component count. Use restrained composition, image-led hierarchy, cohesive content structure, and tasteful motion while avoiding generic cards, weak branding, and interface clutter.
