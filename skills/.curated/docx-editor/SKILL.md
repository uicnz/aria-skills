---
name: docx-editor
description: 'Use when a task involves reading, creating, editing, or reviewing a `.docx` document, especially when formatting or layout fidelity matters.'
---
...
Use `python-docx` for structured document work and the bundled `scripts/render_docx.py` or equivalent DOCX-to-image tooling for visual checks.
...
- Write final artifacts under `output/docx-editor/` when working in this repo.
