---
name: github-ci
description: 'Use when the user asks to investigate or fix failing GitHub Actions checks on a GitHub pull request.'
---
...
Treat external CI providers such as Buildkite as out of scope and report only their details URLs.
