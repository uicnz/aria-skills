...
description: 'Use only when the user explicitly asks to threat-model a codebase or path, enumerate threats or abuse paths, or perform AppSec threat modeling.'
---
...
Enumerate trust boundaries, assets, attacker capabilities, abuse paths, and mitigations in a concise Markdown report. Do not use this workflow for general architecture summaries, code review, or non-security design work.
