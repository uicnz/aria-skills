...
description: 'Use when a user provides a Figma URL or node ID, or asks for production code that must match a Figma design precisely.'
---
...
This skill provides a structured workflow for translating Figma designs into production-ready code with pixel-perfect accuracy. It uses Figma MCP design context, screenshots, and assets, then translates them into project conventions and design tokens while preserving 1:1 visual parity. A working Figma MCP server connection is required.
