---
name: figma-mcp
description: Use when a task involves a Figma URL or node ID, design context or assets, design-to-code implementation, or Figma MCP setup and troubleshooting.
---
...
Use the Figma MCP server to fetch design context, screenshots, variables, and assets, then translate Figma nodes into production code. For setup and debugging details such as environment variables, configuration, and verification, see `references/figma-mcp-config.md`.
