...
description: 'Use only when the user explicitly requests security best-practice guidance, a security review or report, or secure-by-default help for Python, JavaScript, TypeScript, or Go.'
---
...
The bundled language-specific guidance supports Python, JavaScript or TypeScript, and Go. Do not apply this workflow to general code review, debugging, or non-security tasks.
