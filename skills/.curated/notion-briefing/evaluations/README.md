...
Evaluation scenarios for testing the Meeting Intelligence skill across different Aria models.
...
- Enriches with Aria research appropriately
- Creates both internal pre-reads and external agendas
- Distinguishes between Notion facts and Aria insights
...
- Enriches with Aria research (decision frameworks, migration best practices)
- Creates comprehensive internal pre-read with recommendation
- Creates clean, professional external agenda
- Clearly distinguishes Notion facts from Aria insights
...
- Adds Aria context (industry benchmarks, best practices)
...
3. Verify the skill searches Notion first (not Aria research)
4. Check that TWO documents are created (internal + external)
5. Verify Aria enrichment adds value without replacing Notion content
...
4. **Verify enrichment value** - Is Aria research genuinely helpful?
...
- "Aria enrichment includes decision frameworks or best practices"
