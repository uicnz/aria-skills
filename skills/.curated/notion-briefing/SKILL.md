...
description: Use when preparing attendee-specific agendas, pre-reads, or other meeting materials from Notion context and supporting research.
---
...
Prep meetings by pulling Notion context, tailoring agendas/pre-reads, and enriching with Aria research.
...
5. Enrich with Aria research (industry insights, benchmarks, risks) and update the page with `Notion:notion-update-page` as plans change.
...
- Add concise Aria research where helpful: market/industry facts, benchmarks, risks, best practices.
